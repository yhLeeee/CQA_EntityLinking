...
class CoNLLDataset:
    ...
    def __init__(self, path, person_path, conll_path):
        print('load csv')
        self.train_cqa_0 = read_csv_file(path + '/cqa_train_data_0.csv')
        self.train_cqa_1 = read_csv_file(path + '/cqa_train_data_1.csv')
        self.train_cqa_2 = read_csv_file(path + '/cqa_train_data_2.csv')
        self.train_cqa_3 = read_csv_file(path + '/cqa_train_data_3.csv')
        self.train_cqa_4 = read_csv_file(path + '/cqa_train_data_4.csv')
        self.test_cqa_0 = read_csv_file(path + '/cqa_test_data_0.csv')
        self.test_cqa_1 = read_csv_file(path + '/cqa_test_data_1.csv')
        self.test_cqa_2 = read_csv_file(path + '/cqa_test_data_2.csv')
        self.test_cqa_3 = read_csv_file(path + '/cqa_test_data_3.csv')
        self.test_cqa_4 = read_csv_file(path + '/cqa_test_data_4.csv')
