...
from models.mulrel_nel.nel.local_ctx_att_ranker import LocalCtxAttRanker
import numpy as np
...
class MulRelRanker(LocalCtxAttRanker):
    ...
    def __init__(self, config):
        ...
        if config['deeped']:
            self.rel_embs = torch.nn.Parameter(torch.zeros_like(self.rel_embs), requires_grad=False)
